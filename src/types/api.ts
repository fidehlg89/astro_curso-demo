// To parse this data:
//
//   import { Convert, SpaceXresponse } from "./file";
//
//   const spaceXresponse = Convert.toSpaceXresponse(json);
//
...
export class Convert {
    public static toSpaceXresponse(json: string): SpaceXresponse {
        return cast(JSON.parse(json), r("SpaceXresponse"));
    }

    public static spaceXresponseToJson(value: SpaceXresponse): string {
        return JSON.stringify(uncast(value, r("SpaceXresponse")), null, 2);
    }
}
